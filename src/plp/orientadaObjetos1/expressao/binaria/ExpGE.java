...
/**
 * Um objeto desta classe representa uma expressao de Maior Igual (esq >= dir) entre
 * Expressoes cuja avaliacao resulta num mesmo valor primitivo.
 */
public class ExpGE extends ExpBinaria{

    /**
     * Controi uma expressao de Maior Igual (esq >= dir) com as sub-expressoes especificadas.
    ...
    /**
     * Retorna o valor da expressao de Maior Igual (esq >= dir)
     */
    public Valor avaliar(AmbienteExecucaoOO1 ambiente)
        throws VariavelNaoDeclaradaException, VariavelJaDeclaradaException,
        ObjetoNaoDeclaradoException, ClasseNaoDeclaradaException {
        return verificarMaiorIgual(ambiente);
    }
     ...
     * Maior Igual (esq >= dir) entre duas expressoes
     * @param ambiente ? o Ambiente de Execu??o
     * @return o valor inteiro que representa o resultado da concatenacao de dois Strings
     * @throws ClasseNaoDeclaradaException 
     */
    private ValorBooleano verificarMaiorIgual(AmbienteExecucaoOO1 ambiente)
