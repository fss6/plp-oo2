...
import plp.orientadaObjetos1.expressao.binaria.ExpGE;
import plp.orientadaObjetos1.expressao.binaria.ExpLE;
...
/** * DecClasse ::= "classe" Id ["extends" Id] "{" DecVariavel ";" DecConstrutor ";" DecProcedimento "}" **/
  ...
  DecClasse resposta;
    if (jj_2_38(2147483647)) {
      ...
      jj_consume_token(RBRACE);
                                if (decConstrutor == null){
                                        resposta = new DecClasseSimplesOO2(nomeClasse, superClasse, atributos, metodos);
                                }else{
...
/** * TipoClasse ::= Id **/
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x23b0000,0x0,0x200000,0x2000000,0xa007800,0x2000000,0x80000,0x8006000,0x0,0x2000,0xa007800,0x40000000,0x40000000,0x400,0x400,0x200,0x0,0x2000000,0x0,0x4000000,0x0,0x0,0x80000000,0x0,0x80000000,0x10000000,0x10000000,0x80000000,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1480,0x400,0x0,0x480,0x4c4,0x480,0x0,0x44,0x40,0x0,0x4c4,0x38600000,0x38600000,0x0,0x0,0x0,0x480,0x0,0x80,0x0,0x80,0x80,0x483,0x80,0x83,0x0,0x0,0x83,0x80,0x2,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x8,0x0,0x0,0x0,0x0,0x0,0x8,0x0,0x0,0xe,0xe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
